...
const StudyMode = () => {
  ...
  return (
    <div className="flex bg-black flex-col items-center justify-center min-h-screen text-white studymode"
      style={{
