...
import Questions from "./ADHDquestions";
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <button
                    className="text-sm text-indigo-600 hover:underline font-medium ml-4"
                ...
                {showExample && (
                  <div className="bg-indigo-50 p-4 rounded-md mb-4 text-sm text-gray-700 border border-indigo-200">
                ...
                <div className="flex justify-between mt-10">
                  ...
                  {currentQuestion === Questions.length - 1 ? (
                    <button
                      ...
                      className="px-5 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 disabled:opacity-50 shadow-md"
                    >
                      See Result
                    </button>
                  ) : (
                    <button
                      ...
                      className="px-5 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 shadow-md"
                    >
                      Next
                    </button>
                  )}
