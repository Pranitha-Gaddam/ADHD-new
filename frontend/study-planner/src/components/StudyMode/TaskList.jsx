            ...
            {isActive && (
                ...
                before:absolute before:top-0 before:right-4 before:w-3 before:h-3 before:rotate-45 before:-translate-y-1/2 before:bg-white/30 before:backdrop-blur-md">
                    ...
                    <input
                        ...
                        className="w-full p-2 mt-1 border border-neutral-300 text-white rounded"
                    />
                    <button onClick={addItem} className="mt-2 w-full bg-slate-700 text-white py-1 rounded">Add</button>
                    {items.map((item) => (
                        <TaskItems
                            key={item.id}
                            text={item.text}
