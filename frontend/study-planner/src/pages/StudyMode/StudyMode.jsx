  ...
  return (
    <div className="flex bg-black flex-col items-center justify-center h-screen w-full text-white  studymode">
        ...
        {["Pomodoro", "Short Break", "Long Break"].map((item) => (
          <button
            ...
            className={`px-5 py-2  font-semibold rounded-lg transition-all ${
              mode === item
                ? "border bg-white border-white text-white shadow-md backdrop-filter backdrop-blur-lg bg-opacity-35"
                : "text-white border border-white shadow-sm  hover:shadow-md hover:bg-opacity-30 backdrop-filter backdrop-blur-lg bg-opacity-25"
            }`}
      ...
      <div className="mt-6 flex items-center space-x-4">
        ...
        <button
          className="text-white opacity-60 hover:opacity-80"
          onClick={resetTimer}
        >
          <FaRedo size={18} />
        </button>
